        ...
        <div class="header_con">
            ...
            <div class="header_black_con">
                ...
                <div class="header_front_content">
                    ...
                    <h2 class="header_front_heading">Services</h2>
                    ...
                    echo '
                        ...
                        <div class="full_info_room" id="' . $_value["price"] . '" > 
                            ...
                            <div class="full_info_con">
                                ...
                                <button onclick="call();" class="room_book_btn"> book from ' . $_value["price"] . ' </button>
                            ...
                            <div class="full_info_con_l">
                                ...
                                <img class="service_img_s" src="images/service/' . $_value["images"] . '" alt="">
