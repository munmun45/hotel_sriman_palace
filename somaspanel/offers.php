...
<body class="fixed-navbar">
    ...
    <div class="page-wrapper">
        ...
        <header class="header">
            ...
            <div class="flexbox flex-1">
                <h2 style="font-weight: bold; font-size: 22px; margin-left: 17px;">Our Offers</h2>
        ...
        <div id="Room" class="content-wrapper">
            ...
            <div class="Description_slider_con">
                ...
                while ($_value = mysqli_fetch_assoc($result)) {
                    ...
                    echo '
                    <div class="offers_con" >

                        <p class="o_P" > ' . $_value["message"] . ' </p>

                        <div class="edit_btn" onclick="window.open(`delete.php?id=' . $_value["id"] . '&t_vlaue=offers`,`_self`)" >
    ...
    <div class="Form_popup" id="popup">
        ...
        <div class="uplode_room_Form">
            ...
            <form id="event_form" action="offers_insert.php" method="post" enctype="multipart/form-data">
                ...
                <div class="form">
                    ...
                    <div class="form_con">
                        ...
                        <textarea class="flli_message" name="para" id="event_para" placeholder="Enter Offer "></textarea>
