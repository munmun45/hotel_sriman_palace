    ...
    <div class="page-wrapper">
        ...
        <header class="header">
            ...
            <div class="flexbox flex-1">
                <h2 style="font-weight: bold; font-size: 22px; margin-left: 17px;">Our Story</h2>
        ...
        <div id="slider" class="content-wrapper">
            ...
            <div class="Description_slider_con">
                ...
                $sql = "SELECT * FROM `our_story` ORDER BY id DESC ";
                ...
                while ($_value = mysqli_fetch_assoc($result)) {
                    ...
                    echo '
                            ...
                            <div class="Image_con" >
                                <img class="Image_con_img" src="../images/about/' . $_value["Image_1"] . '" alt="">
                                

                                <form action="our_story_insert.php" method="POST" enctype="multipart/form-data" name="slider_img">
                                    <div class="Delet_img_con" id="yourBtn"  onclick="getFile()" >
                                    ...
                                    <div style="height: 0px;width: 0px; overflow:hidden;"> <input  name="v" type="text" value = "Image_1"/> </div>
                                    <div style="height: 0px;width: 0px; overflow:hidden;"> <input  name="id" type="text" value = "' . $_value["id"] . '"/> </div>
                                </form>

                            </div>
                            <div class="Image_con" >
                                <img class="Image_con_img" src="../images/about/' . $_value["Image_2"] . '" alt="">
                                

                                <form action="our_story_insert.php" method="POST" enctype="multipart/form-data" name="slider_img2">
                                    <div class="Delet_img_con" id="yourBtn2"  onclick="getFile2()" >
                                        <img src="images/icon/pencil.png" alt="">
                                    </div>
                                    <div style="height: 0px;width: 0px; overflow:hidden;"> <input accept=".jpg, .jpeg" id="upfile2" name="doc" type="file" value="upload" onchange="sub2(this)" /> </div>
                                    <div style="height: 0px;width: 0px; overflow:hidden;"> <input  name="v" type="text" value = "Image_2"/> </div>
                                    <div style="height: 0px;width: 0px; overflow:hidden;"> <input  name="id" type="text" value = "' . $_value["id"] . '"/> </div>
                                </form>
