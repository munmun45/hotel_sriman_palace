    ...
    <div class="page-wrapper">
        ...
        <header class="header">
            ...
            <div class="flexbox flex-1">
                <h2 style="font-weight: bold; font-size: 22px; margin-left: 17px;">Activity</h2>
                ...
                while ($_value = mysqli_fetch_assoc($result)) {
                    ...
                    echo '
                            <div class="event_main_con">
                                ...
                                <div class="E_img_con" >
                                    <img src="../images/activity/' . $_value["images"] . '" alt="">
                                </div>
                                ...
                                <div class="Delet_room_con"  onclick="window.open(`delete.php?id=' . $_value["id"] . '&t_vlaue=activity`,`_self`)" >
                                    <img  class="icon_img" src="images/icon/trash.png" alt="">
                                </div>
                                <div class="update_room_con" onclick="event_popup(`' . $_value["id"] . '`,`' . $_value["name"] . '`,`' . $_value["para"] . '`);" >
                    ...
                    <div class="form">
                        ...
                        <div class="form_con f">
                            ...
                            <div class="form_sub_con">
                                ...
                                <input class="input_text" type="text" name="name" id="event_name" placeholder="Activity Name">
        ...
        <script>
            ...
            function event_popup(id, name, para) {
                ...
                if (id) {
                    ...
                    room_form.setAttribute("action", "update_activity.php");
                    Form_title.innerText = " Update Activity ";
                    ...
                    room_form.setAttribute("action", "activity_insert.php");
                    Room_save_btn.setAttribute("value", "Submit");

                    Form_title.innerText = " Add New Activity ";
