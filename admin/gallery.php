    ...
    <div class="page-wrapper">
        ...
        <header class="header">
            ...
            <div class="flexbox flex-1">
                <h2 style="font-weight: bold; font-size: 22px; margin-left: 17px;">Our Gallery</h2>
        ...
        <div id="slider" class="content-wrapper">
            ...
            <br>
            <form class="upload_flot" action="gallery_insert.php" method="POST" enctype="multipart/form-data" name="slider_img">

                <div id="yourBtn" onclick="getFile()">
                    <img src="images/icon/uplading.png" alt="">
                </div>
                <div accept=".jpg, .jpeg" style='height: 0px;width: 0px; overflow:hidden;'> <input id="upfile" name="doc" type="file" value="upload" onchange="sub(this)" /> </div>
            ...
            <div class="Description_slider_con">
                ...
                while ($_value = mysqli_fetch_assoc($result)) {
                    ...
                    echo '
                            ...
                            <div class="Image_con" >
                                <img class="Image_con_img" src="../images/gallery/' . $_value["images"] . '" alt="">
                                <div class="Delet_img_con" onclick="window.open(`delete.php?id=' . $_value["id"] . '&t_vlaue=gallery`,`_self`)" >
